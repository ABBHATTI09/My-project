...
<head>
    ...
    <title>Appointment Completion Status</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h2>Appointment Completion Status</h2>
        </div>

        <div class="content">
            <p>Dear <span class="highlight">{{$data['mediator_name']}}</span>,</p>

            <p>Dr. <span class="highlight">{{$data['doctor_name']}}</span> has updated the status of the appointment for patient <span class="highlight">{{$data['patient_name']}}</span>. Here are the details:</p>
            ...
            <p><strong>Appointment Doctor Status:</strong> <span class="highlight">
