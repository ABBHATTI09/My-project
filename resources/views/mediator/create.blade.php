...
@section('content')
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Mediator Form </h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Mediator Form </h5>
                      <a href="{{route('mediator.index')}}" class="btn btn-primary">Back</a>
                    </div>
                    <div class="card-body">
                      <form action="{{route('mediator.store')}}" method="POST">
                        ...
                        <div class="row mb-3">
                          ...
                          <select name="status" id="status" class="form-control">
                            <option value="">---choose Mediator status---</option>
